"""
Django settings for langdeath project.
...
ROOT_URLCONF = 'langdeath.urls'

WSGI_APPLICATION = 'langdeath.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'langdeath.db.sqlite3'),
    }
}
